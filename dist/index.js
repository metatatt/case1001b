...
},{}],"etoTM":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "ab2cbcab7ee0bb0a";
...
},{}],"dx9C4":[function(require,module,exports) {
/* globals AFRAME */ AFRAME.registerComponent("artgalleryframe", {
    schema: {
        name: {
            type: "string"
        },
    ...
    init () {
        ...
        if (this.data.rotated) // Rotate the frame for a landscape target
        ...
        infoDisplay.setAttribute("info-display", {
            title,
            artist,
            date
        });
        ...
        if (this.data.rotated) // Rotate the tap target for a landscape target
...
},{}]},["1xC6H","etoTM","dx9C4"], "dx9C4", "parcelRequirecbee")
